...
gh workflow run "JMeter Load Test" --repo Acaris-App/Backend --ref main `
  -f target_url=https://acaris-service-649442063927.asia-southeast2.run.app/health `
  -f users=50 `
  -f ramp_up=30 `
  -f duration=60
```
...
```powershell
gh run list --repo Acaris-App/Backend --workflow "JMeter Load Test" --limit 5
```
