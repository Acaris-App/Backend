      ...
      .post("/register/mahasiswa", () => ({}), {
        body: t.Object({
          ...
          konsentrasi: t.Optional(t.Union([
            t.Literal("Rekayasa Perangkat Lunak"),
            t.Literal("Sistem Cerdas"),
            t.Literal("Teknik Komputer"),
            t.Literal("Teknologi Informasi"),
        ...
        detail: {
          ...
          description: "Registrasi akun mahasiswa. Mendukung multipart/form-data untuk unggah foto profil. angkatan tidak dikirim: tahun masuk dibaca dari dua digit pertama NPM. Tahun masuk sebelum 2025 memakai TI-2020; mulai 2025 memakai TI-2025. konsentrasi wajib untuk mahasiswa semester 5 ke atas.",
